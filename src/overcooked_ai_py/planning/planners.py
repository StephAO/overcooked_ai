...
class MotionPlanner(object):
    ...
    def min_cost_between_features(self, pos_list1, pos_list2, with_argmin = False,manhattan_if_fail=False):
        """
        ...
        best_feature = None
        if all(i is None for i in pos_list1) or all(i is None for i in pos_list1) :
            return None
